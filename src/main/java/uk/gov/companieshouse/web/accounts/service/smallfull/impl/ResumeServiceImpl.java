...
public class ResumeServiceImpl implements ResumeService {
    ...
    public String getResumeRedirect(String companyNumber, String transactionId, String companyAccountsId) {
        ...
        return UrlBasedViewResolver.REDIRECT_URL_PREFIX + "/company/" + companyNumber + "/transaction/" + transactionId + "/company-accounts/" + companyAccountsId + "/small-full/balance-sheet";
    }
}
