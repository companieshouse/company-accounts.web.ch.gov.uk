...
public class CurrentPeriod {
    ...
    @ValidationMapping("$.intangible_assets.goodwill.net_book_value.current_period")
    private Long goodwill;

    @ValidationMapping("$.intangible_assets.other_intangible_assets.net_book_value.current_period")
    private Long otherIntangibleAssets;

    @ValidationMapping("$.intangible_assets.total.net_book_value.current_period")
    private Long total;
