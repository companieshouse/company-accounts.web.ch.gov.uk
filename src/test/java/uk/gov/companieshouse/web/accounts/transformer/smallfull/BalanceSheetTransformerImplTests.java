...
class BalanceSheetTransformerImplTests {
    ...
    void getCurrentPeriodLBG() {
        ...
        BalanceSheetApi currentPeriodBalanceSheet = transformer.getCurrentPeriodBalanceSheet(
                balanceSheet);
    ...
    void getPreviousPeriodLBG() {
        ...
        BalanceSheetApi previousPeriodBalanceSheet = transformer.getPreviousPeriodBalanceSheet(
                balanceSheet);
    ...
    private void verifyCurrentPeriodWebToApiTransformersCalled(boolean isLbg) {
        ...
        verify(fixedAssetsTransformer, times(1)).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(calledUpShareCapitalNotPaidTransformer, times(1)).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(currentAssetsTransformer, times(1)).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(otherLiabilitiesOrAssetsTransformer, times(1)).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        if (isLbg) {
    ...
    private void verifyPreviousPeriodWebToApiTransformersCalled(boolean isLbg) {
        ...
        verify(fixedAssetsTransformer, times(1)).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(calledUpShareCapitalNotPaidTransformer, times(1)).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(currentAssetsTransformer, times(1)).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(otherLiabilitiesOrAssetsTransformer, times(1)).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        if (isLbg) {
            verify(membersFundsTransformer, times(1))
    ...
    private void verifyCurrentPeriodApiToWebTransformersCalled() {
        ...
        verify(fixedAssetsTransformer, times(1)).addCurrentPeriodToWebModel(any(BalanceSheet.class),
                any(BalanceSheetApi.class));
        verify(calledUpShareCapitalNotPaidTransformer, times(1)).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(currentAssetsTransformer, times(1)).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(otherLiabilitiesOrAssetsTransformer, times(1)).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(capitalAndReservesTransformer, times(1)).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(membersFundsTransformer, times(1)).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
    ...
    private void verifyPreviousPeriodApiToWebTransformersCalled() {
        ...
        verify(fixedAssetsTransformer, times(1)).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(calledUpShareCapitalNotPaidTransformer, times(1)).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(currentAssetsTransformer, times(1)).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(otherLiabilitiesOrAssetsTransformer, times(1)).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(capitalAndReservesTransformer, times(1)).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(membersFundsTransformer, times(1)).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
    }

    private void verifyCurrentPeriodWebToApiTransformersNotCalled() {

        verify(fixedAssetsTransformer, never()).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(calledUpShareCapitalNotPaidTransformer, never()).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(currentAssetsTransformer, never()).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(otherLiabilitiesOrAssetsTransformer, never()).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(capitalAndReservesTransformer, never()).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(membersFundsTransformer, never()).addCurrentPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
    }

    private void verifyPreviousPeriodWebToApiTransformersNotCalled() {

        verify(fixedAssetsTransformer, never()).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(calledUpShareCapitalNotPaidTransformer, never()).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(currentAssetsTransformer, never()).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(otherLiabilitiesOrAssetsTransformer, never()).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(capitalAndReservesTransformer, never()).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
        verify(membersFundsTransformer, never()).addPreviousPeriodToApiModel(
                any(BalanceSheetApi.class), any(BalanceSheet.class));
    }

    private void verifyCurrentPeriodApiToWebTransformersNotCalled() {

        verify(fixedAssetsTransformer, never()).addCurrentPeriodToWebModel(any(BalanceSheet.class),
                any(BalanceSheetApi.class));
        verify(calledUpShareCapitalNotPaidTransformer, never()).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(currentAssetsTransformer, never()).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(otherLiabilitiesOrAssetsTransformer, never()).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(capitalAndReservesTransformer, never()).addCurrentPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(membersFundsTransformer, never()).addCurrentPeriodToWebModel(any(BalanceSheet.class),
                any(BalanceSheetApi.class));
    ...
    private void verifyPreviousPeriodApiToWebTransformersNotCalled() {
        ...
        verify(fixedAssetsTransformer, never()).addPreviousPeriodToWebModel(any(BalanceSheet.class),
                any(BalanceSheetApi.class));
        verify(calledUpShareCapitalNotPaidTransformer, never()).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(currentAssetsTransformer, never()).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(otherLiabilitiesOrAssetsTransformer, never()).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(capitalAndReservesTransformer, never()).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
        verify(membersFundsTransformer, never()).addPreviousPeriodToWebModel(
                any(BalanceSheet.class), any(BalanceSheetApi.class));
    }
}
