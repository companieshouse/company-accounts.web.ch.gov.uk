...
class OtherAccountingPolicyControllerTest {
    ...
    void postRequestSuccess() throws Exception {
        ...
        verify(accountingPoliciesDataState, times(1)).setHasProvidedOtherAccountingPolicy(
                anyBoolean());

        verify(radioAndTextValidator).validate(eq(true), eq(null), any(BindingResult.class),
                eq(INVALID_STRING_SIZE_ERROR_MESSAGE), eq(OTHER_ACCOUNTING_POLICY_FIELD_PATH));
    }
