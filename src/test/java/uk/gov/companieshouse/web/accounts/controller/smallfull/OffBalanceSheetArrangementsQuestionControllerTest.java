...
class OffBalanceSheetArrangementsQuestionControllerTest {
    ...
    private static final String OFF_BALANCE_SHEET_ARRANGEMENTS_QUESTION_PATH =
    ...
    void getOffBalanceSheetArrangementsQuestionHasArrangements() throws Exception {
        ...
        when(offBalanceSheetArrangements.getOffBalanceSheetArrangementsDetails()).thenReturn(
                ARRANGEMENTS);
        ...
        mockMvc.perform(get(OFF_BALANCE_SHEET_ARRANGEMENTS_QUESTION_PATH))
                ...
                .andExpect(
                        model().attributeExists(OFF_BALANCE_SHEET_ARRANGEMENTS_QUESTION_MODEL_ATTR))
                .andExpect(model().attribute(OFF_BALANCE_SHEET_ARRANGEMENTS_QUESTION_MODEL_ATTR,
                        hasProperty(
    ...
    void getOffBalanceSheetArrangementsQuestionDoesNotHaveArrangements() throws Exception {
        ...
        when(companyAccountsDataState.getHasIncludedOffBalanceSheetArrangements()).thenReturn(
                false);
    ...
    void submitOffBalanceSheetArrangementsQuestionHasArrangements() throws Exception {
        ...
        verify(noteService, never()).delete(TRANSACTION_ID, COMPANY_ACCOUNTS_ID,
                NoteType.SMALL_FULL_OFF_BALANCE_SHEET_ARRANGEMENTS);
    ...
    void submitOffBalanceSheetArrangementsQuestionDoesNotHaveArrangements() throws Exception {
        ...
        verify(noteService).delete(TRANSACTION_ID, COMPANY_ACCOUNTS_ID,
                NoteType.SMALL_FULL_OFF_BALANCE_SHEET_ARRANGEMENTS);
    ...
    void submitOffBalanceSheetArrangementsQuestionThrowsServiceException() throws Exception {
        ...
        doThrow(ServiceException.class)
                .when(noteService)
                .delete(TRANSACTION_ID, COMPANY_ACCOUNTS_ID,
                        NoteType.SMALL_FULL_OFF_BALANCE_SHEET_ARRANGEMENTS);
