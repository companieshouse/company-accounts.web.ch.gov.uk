...
class CreditorsWithinOneYearDateHandlerTest {
    ...
    @InjectMocks
    private DateHandler<CreditorsWithinOneYear> creditorsWithinOneYearDateHandler = new CreditorsWithinOneYearDateHandler();
