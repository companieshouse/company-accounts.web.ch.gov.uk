...
locals {
  ...
  lb_listener_paths      = ["/accounts/*","/company/*/transaction/*/company-accounts/*","/company/*/small-full/steps-to-complete","/company-accounts-web/healthcheck","/company/*/corporation-tax","/company/*/select-account-type","/company/*/cic/steps-to-complete","/company/*/*/criteria"]
